...
import { Users, MapPin, FileText, LayoutDashboard, Flag, UserCog, TrendingUp, MessageSquareHeart, Megaphone } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/ads", label: "Publicidade", icon: Megaphone },
